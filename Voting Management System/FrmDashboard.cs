...
namespace Voting_Management_System
{
    public partial class FrmDashboard : Form
    {
        ...
        private void BtnVote_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                String query = "update voters set status = @status where voters_id = @id";
                MySqlCommand cmd = new MySqlCommand(query, con);
                cmd.Parameters.AddWithValue("@status", "Voted");
                cmd.Parameters.AddWithValue("@id", GlobalVar.voters_id);
                cmd.ExecuteNonQuery();
                con.Close();
                NotificationVoteSuccess a = new NotificationVoteSuccess();
                a.ShowDialog();
                this.Hide();
        ...
        {
            TransparentDashboard a = new TransparentDashboard();
            FrmPreview b = new FrmPreview();
